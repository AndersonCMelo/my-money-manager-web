      ...
      <CardContent className="flex flex-col p-2 sm:p-4">
        <div>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="text-primary-blue w-[30px] px-1 sm:px-3 h-10 sm:h-12">
                  #
                </TableHead>
                ...
                <TableHead className="text-primary-blue text-right px-1 sm:px-3 h-10 sm:h-12">
                  Color
                </TableHead>
            ...
            <TableBody>
              {categories.map((category) => (
                <TableRow key={category.id} className="py-2">
                  ...
                  <TableCell className="flex justify-end items-center text-slate-500 text-right text-xs py-2 px-1 sm:px-3">
                    <div
